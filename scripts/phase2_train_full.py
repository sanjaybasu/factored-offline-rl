...
Production-quality LSTM training with full tracking and evaluation.
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/Users/sanjaybasu/waymark-local/notebooks/factored_rl/phase2_full_training.log'),
