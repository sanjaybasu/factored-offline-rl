...
from offline_rl_policy_awr import ActionEmbeddingNetwork
...
def audit_fairness(
    ...
    from offline_rl_policy_awr import select_action
...
if __name__ == "__main__":
    audit_fairness(
        data_path=str(data_dir / 'merged_trajectories.parquet'),
        policy_path=str(model_dir / 'trained_policy.pt')
    )
